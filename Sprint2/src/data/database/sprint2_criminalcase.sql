...
CREATE TABLE `criminalcase` (
  ...
  PRIMARY KEY (`criminalCaseId`,`evidenceId`,`assignedId`,`leadInvestigatorId`),
  UNIQUE KEY `number` (`number`),
  UNIQUE KEY `evidenceId` (`evidenceId`),
  KEY `lead_investigator_fk` (`leadInvestigatorId`),
...
INSERT INTO `criminalcase` VALUES (1,1,'2022-06-13 00:00:00','2022-06-13 00:00:00','1','UNCATEGORIZED','hihi','haha','SUBMITTED','hihi',1,1,1);
